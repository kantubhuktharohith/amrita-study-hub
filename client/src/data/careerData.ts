    ...
    options: [
      {
        ...
        description: "Building production software, APIs, and mobile apps with agile teams.",
        suggestedCategory: "Software & IT",
        suggestedDepartments: ["Computer Science & Engineering"],
      },
      {
        label: "Jupyter Notebooks, PyTorch, SQL, and Power BI dashboards",
        description: "Crunching large datasets, predictive analytics, and training neural networks.",
        suggestedCategory: "AI & Data",
        suggestedDepartments: [
          "Computer Science & Engineering (AI & ML)",
          "Computer Science & Engineering (Data Science)",
      ...
      },
      {
        ...
        description: "Tinkering with hardware labs, microcontrollers, and silicon chip synthesis.",
        suggestedCategory: "Hardware & Core",
        suggestedDepartments: ["Electronics & Communication", "Electrical & Electronics"],
      },
      {
        label: "Kali Linux, Wireshark, Burp Suite, and Terminal Security Defenses",
        description: "Penetration testing, network monitoring, and hunting system vulnerabilities.",
        suggestedCategory: "Cyber & Cloud",
        suggestedDepartments: ["Computer Science & Engineering (Cyber Security)"],
      },
      {
        label: "SolidWorks, ANSYS, ETABS, Revit, or Construction Sites",
        description: "Physical engineering, mechanical CAD simulations, and civil infrastructure.",
        suggestedCategory: "Civil & Structural",
        suggestedDepartments: ["Mechanical Engineering", "Civil Engineering"],
      },
      {
        label: "Standard Reference Books, GATE Question Banks, NPTEL & Research Papers",
        description: "Rigorous academic study, derivations, and deep theoretical problem-solving.",
        suggestedCategory: "Government & Higher Studies",
        suggestedDepartments: ["All Departments"],
      },
    ],
    ...
    options: [
      {
        ...
        description: "Focus on DSA, system design, scalable development, and tech campus placements.",
        suggestedCategory: "Software & IT",
        suggestedDepartments: ["Computer Science & Engineering"],
      },
      {
        label: "AI Researcher / Data Scientist / Machine Learning Engineer",
        description: "Specializing in the booming artificial intelligence and big data ecosystem.",
        suggestedCategory: "AI & Data",
        suggestedDepartments: [
          "Computer Science & Engineering (AI & ML)",
          "Computer Science & Engineering (Data Science)",
      ...
      {
        label: "Cyber Security Specialist / Ethical Hacker / Cloud Security Engineer",
        description: "Defending enterprises, banks, and defense cloud networks from threats.",
        suggestedCategory: "Cyber & Cloud",
        suggestedDepartments: ["Computer Science & Engineering (Cyber Security)"],
      },
      {
        label: "Core Engineering Giant (Qualcomm, Texas Instruments, L&T, Tata Motors)",
        description: "Building semiconductor, automotive, aerospace, or electrical drives.",
        suggestedCategory: "Hardware & Core",
        suggestedDepartments: ["Electronics & Communication", "Electrical & Electronics", "Mechanical Engineering"],
      },
      {
        label: "Infrastructure & Smart City Pioneer (L&T Construction, Afcons, Structural Design)",
        description: "Designing mega infrastructure, high-rise buildings, bridges, and BIM models.",
        suggestedCategory: "Civil & Structural",
        suggestedDepartments: ["Civil Engineering", "Mechanical Engineering"],
      },
      {
        label: "Govt / PSU Job (ISRO, DRDO, IOCL) or M.Tech from IITs / MS Abroad",
        description: "High job security, prestige, or pursuing world-class higher studies & research.",
        suggestedCategory: "Government & Higher Studies",
        suggestedDepartments: ["All Departments"],
      },
    ],
